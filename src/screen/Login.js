...
export default class Login extends Component {
  ...
  render() {
    return (
      <View style={{height: hp(100), backgroundColor: 'white'}}>
        ...
        <Text style={[styles.descriptionTextStyle, {fontSize: hp(2)}]}>
  ...
  onUserisSuccess = (response) => {
    ...
    Services.getUserProfile((userProfile) => {
      console.log('userProfile', userProfile);
      if (
        userProfile.user._data === undefined ||
        userProfile.user._data.biodata === undefined
      ) {
